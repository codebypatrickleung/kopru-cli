...
- **Operating System**: (If the OS is not listed, you might need to update the OS configuration script or just drop me a [message on Linkedin](https://www.linkedin.com/in/pgwl/))
